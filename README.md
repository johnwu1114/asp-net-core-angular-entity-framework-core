...
介紹 Angular 4 跟 ASP.NET Core Web Api 透過 AJAX 的互動，範例是做一個簡單的通訊錄。功能包含新增(Create)、查詢(Read)、修改(Update)跟刪除(Delete)，簡稱CRUD。  
並透過 Angular 4 的 Routing 實現 Single Page Application(SPA)  

Blog：  
[ASP.NET Core + Angular 4 教學 - Web Api CRUD](https://blog.johnwu.cc/article/asp-net-core-angular-4-%E6%95%99%E5%AD%B8-routing.html)  
[ASP.NET Core + Angular 4 教學 - Routing](https://blog.johnwu.cc/article/asp-net-core-angular-4-%E6%95%99%E5%AD%B8-web-api-crud.html)
